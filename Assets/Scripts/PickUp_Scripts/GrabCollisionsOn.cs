...
public class GrabCollisionsOn : MonoBehaviour
{
    ...
    public static HashSet<GameObject> uniqueCollidableObjs;
    // [SerializeField] private GameObject[] collidableObjects;
    // private int colliderCount = 0;
    private bool allLayersAdded;
    // public List<GameObject> CollidableObjects => collidableObjects;
...
// #endif
    ...
    //    
    //     foreach (GameObject obj in uniqueCollidableObjs)
    //     {
    //         if (obj != null)
    //         {
